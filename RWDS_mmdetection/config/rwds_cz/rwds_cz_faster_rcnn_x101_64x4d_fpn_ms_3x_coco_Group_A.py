...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        ann_file='train/Group_A_train_512_02.json',
        data_prefix=dict(img='train/Group_A_train_images_512_02'),
        ),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=dict(classes=classes),
        data_root=data_root,
        ann_file='val/Group_A_val_512_02.json',
        data_prefix=dict(img='val/Group_A_val_images_512_02'),
        )
    )
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        metainfo=dict(classes=classes),
        data_root=data_root,
        ann_file='test/Group_A_test_512_02.json',
        data_prefix=dict(img='test/Group_A_test_images_512_02'),
        )
    )
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'val/Group_A_val_512_02.json',
    metric='bbox',
    format_only=False,
...
format_only=False,
backend_args=None,
 ann_file=data_root + 'test/Group_A_test_512_02.json',)
